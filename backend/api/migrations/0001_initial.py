    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('type', models.CharField(choices=[('MCQ', 'Multiple Choice'), ('SA', 'Short Answer')], max_length=3)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('type', models.CharField(choices=[('MCQ', 'Multiple Choice'), ('SA', 'Short Answer')], max_length=3)),
                ('question_text', models.TextField()),
                ('options', models.JSONField(blank=True, help_text='Applicable for MCQs', null=True)),
                ('correct_answer', models.TextField()),
                ('created_at', models.DateTimeField(auto_now_add=True)),
